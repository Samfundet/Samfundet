...
ActiveRecord::Schema.define(version: 20_160_922_182_658) do
  ...
  add_index 'page_revisions', %w(page_id version), name: 'index_page_revisions_on_page_id_and_version', unique: true
