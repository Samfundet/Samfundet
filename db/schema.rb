...
ActiveRecord::Schema.define(version: 20170109184205) do
  ...
  create_table "admissions", force: :cascade do |t|
    ...
    t.string   "promo_video",                 limit: 255, default: "https://www.youtube.com/embed/T8MjwROd0dc"
  end
  ...
  create_table "billig_price_groups", primary_key: "price_group", force: :cascade do |t|
    ...
    t.boolean  "netsale"
    t.integer  "price"
    t.string   "price_group_name",   limit: 255
  ...
  create_table "billig_ticket_groups", primary_key: "ticket_group", force: :cascade do |t|
    ...
    t.integer  "num"
    t.integer  "num_sold"
    t.string   "ticket_group_name",       limit: 255
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  ...
  create_table "events", force: :cascade do |t|
    t.string   "non_billig_title_no",   limit: 255
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    ...
    t.string   "lastfm_link",           limit: 255
    t.string   "snapchat_link",         limit: 255
    t.string   "vimeo_link",            limit: 255
    t.string   "general_link",          limit: 255
    t.string   "banner_alignment",      limit: 255
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.string   "title_no",                   limit: 255
    t.string   "title_en",                   limit: 255
    t.string   "teaser_no",                  limit: 255
    t.string   "teaser_en",                  limit: 255
  ...
  create_table "page_revisions", force: :cascade do |t|
    ...
    t.text     "content_no"
    t.text     "content_en"
    t.string   "content_type", limit: 255, default: "markdown", null: false
  ...
  create_table "sulten_reservations", force: :cascade do |t|
    ...
    t.string   "internal_comment",    limit: 255
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
