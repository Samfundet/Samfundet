...
ActiveRecord::Schema.define(version: 2022_03_08_194249) do
  ...
  create_table "interview_time_slots", force: :cascade do |t|
  ...
  create_table "interviews", force: :cascade do |t|
    ...
    t.integer "interview_time_slot_id"
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.integer "interview_interval", default: 30, null: false
    t.string "contact_email"
    t.string "contact_phone"
    t.boolean "linkable_interviews", default: false, null: false
  ...
  create_table "unavailable_interview_time_slots", force: :cascade do |t|
    t.datetime "start_time"
    t.datetime "end_time"
    t.integer "admission_id"
    t.integer "applicant_id"
  ...
  add_foreign_key "interview_time_slots", "admissions"
  add_foreign_key "interview_time_slots", "groups"
  add_foreign_key "interview_time_slots", "jobs"
  add_foreign_key "interviews", "interview_time_slots"
  ...
  add_foreign_key "unavailable_interview_time_slots", "admissions"
  add_foreign_key "unavailable_interview_time_slots", "applicants"
end
