...
Area.all.each do |area|
  ...
  possible_number_of_events_per_area.sample.times do |time|
      ...
      Event.create!(
        ...
        short_description_en: Faker::Lorem.sentences(number: 12),
        short_description_no: Faker::Lorem.sentences(number: 12),
        long_description_en: Faker::Lorem.sentences(number: 100),
        long_description_no: Faker::Lorem.sentences(number: 100),
