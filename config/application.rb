...
module Samfundet
  class Application < Rails::Application
    ...
    config.assets.precompile += ['linkgraph.js', 'old_samfundet/interviews.js', 'job_applications/job_applications.js', 'old_samfundet/jobs_search.js', 'job_applications/admissions_admin_job_applications.js', 'sulten/duration.js', '*.png']
